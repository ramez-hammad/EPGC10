...
void create_nav_sector(lv_obj_t *nav_sector, int ang_start, int ang_end, int x_offset, int y_offset)
{
    ...
    lv_obj_set_size(nav_sector, 110, 105);
...
void create_button_matrix_part_mid(void)
{
    ...
    lv_obj_align(btn_matrix_part_mid, LV_ALIGN_LEFT_MID, -19, 0);
    ...
    // Left
    create_nav_sector(btn_matrix_part_mid_nav_1, 135, 225, -2, 0);

    // Right
    create_nav_sector(btn_matrix_part_mid_nav_2, 315, 45, 2, 0);

    // Up
    create_nav_sector(btn_matrix_part_mid_nav_3, 225, 315, 0, -2);

    // Down
    create_nav_sector(btn_matrix_part_mid_nav_4, 45, 135, 0, 2);
}
